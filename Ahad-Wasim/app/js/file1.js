...
(function(window, $){
  ...
  // In normal cases I would use a template

  trendingSongsJSON.songs.forEach((song, index, collection) => {
    ...
    artistData.appendChild($.createTextNode(`${song.artist} - ${song.album}`))
